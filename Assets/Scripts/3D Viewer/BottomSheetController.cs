...
public class BottomSheetController : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    //[SerializeField] private float midPosition = 100f; // Optionale Zwischenposition //not needed right now
    [SerializeField] private float minPosition = -270f; // Komplett versteckt
    [SerializeField] private float snapSpeed = 5f;

    //private bool isActive = true; // Startet als 'aktiv', Bottom Sheet ist offen //not needed right now
    ...
    public void ShowBottomSheet()
    {
        ...
        //isActive = true; // Es ist jetzt aktiv //not needed right now
    }
    ...
    public void HideBottomSheet()
    {
        ...
        //isActive = false; //not needed right now
    }
